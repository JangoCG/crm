    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                ...
                <div><label style="width:109.6px;">Produkt-ID</label><input type="text" class="ml-2" style="background-color:#ffffff;"></div>
                <div><label style="width:109.6px;">Name</label><input type="text" class="ml-2" style="background-color:#ffffff;"></div>
                <div><label style="width:109.6px;">Kategorie</label><input type="text" class="ml-2"></div>
                <div><label style="width:109.6px;">Menge</label><input type="text" class="ml-2"></div>
                <div><label style="width:109.6px;">Preis</label><input type="text" class="ml-2"><button class="btn btn-primary such-button" type="button">Produkt anlegen</button></div>
            </div>
        </div>
    </div>
</div>
