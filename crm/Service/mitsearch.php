...
<head>
    <title>Mitarbeiter suchen</title>
    <?php
...
<div id="wrapper">
    ...
    <div class="row">
        <div class="col">
            <form action="mitsearch.php" method="post">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $selectStatement = "SELECT ID, Vorname, Nachname, Firma, Email, PLZ, Land, Strasse, Hausnummer, Stadt FROM mitarbeiter
